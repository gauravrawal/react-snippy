...
<head>
    <title>Code coverage report for ResizableBox.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> ResizableBox.js</h1>
        <div class='clearfix'>
...
&nbsp;
  static getDerivedStateFromProps(props: ResizableBoxProps, state: ResizableBoxState) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (state.propsWidth !== props.width || state.propsHeight !== props.height) {
...
&nbsp;
  onResize = (e: SyntheticEvent&lt;&gt;, data: ResizeCallbackData) =&gt; {
    const {size} = data;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.onResize) {
      e.persist &amp;&amp; e.persist();
      this.setState(size, () =&gt; this.props.onResize &amp;&amp; this.props.onResize(e, data));
    } else {
<span class="cstat-no" title="statement not covered" >      this.setState(size);</span>
    }
  };
&nbsp;
  render(): ReactNode {
